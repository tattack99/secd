...
class PodServiceV1(PodServiceProtocol):
    ...
    def _create_container(self, name: str, image: str, envs: List[client.V1EnvVar], mounts: List[client.V1VolumeMount], resources: client.V1ResourceRequirements) -> client.V1Container:
    ...
    def _create_pod_object(self, name: str, labels: Dict[str, str], spec: client.V1PodSpec) -> client.V1Pod:
        return client.V1Pod(
