...
class MySQLService:
    def __init__(self) -> None:
        self.msqlSettings = get_settings()['db']['mysql']
        self.client = mysql.connector.connect(
            host=self.msqlSettings['host'],
            user=self.msqlSettings['username'],
            password=self.msqlSettings['password'],
        )
    ...
    def delete_mysql_user(self, db_user: str):
